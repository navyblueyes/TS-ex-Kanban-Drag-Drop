// abstracted api fetch calls
//   why abstract an fetch(req, res)?
//      1) can easily switch between axios without breaking code
//      2) easier to isolate/test if async functions are kept separate
